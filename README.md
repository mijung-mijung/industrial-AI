...
- `2020-10` [산업 컴퓨터비전 실제](https://github.com/mijung-mijung/industrial-AI/tree/master/projects/산업-컴퓨터비전-실제): OpenCV를 활용한 영상 개선, 영상 분할, 객체 검출/추적 구현 
- `2020-10` [지능로봇 실제](https://github.com/mijung-mijung/industrial-AI/tree/master/projects/지능로봇-실제): 로봇 운영체제 ROS를 중심으로 지능형 로봇 설계 및 운영 실습
- `2020-10` [산업 빅데이터 분석 실제](https://github.com/mijung-mijung/industrial-AI/tree/master/projects/산업-빅데이터분석-실제): 파이썬 패키지를 사용한 빅데이터 분석 및 시각화 기술 학습
